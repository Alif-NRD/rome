#!/usr/bin/python3 
#Coded by : Alif Nurdin
#Github : https://github.com/Alif-NRD
#Facebook : https://www.facebook.com/profile.php?id=100076695461489&mibextid=kFxxJD
###---------------------[IMPORT MODULES]---------------------###
...
try:os.mkdir('/sdcard/Alif')
except:pass
try:os.mkdir('/sdcard/Alif/OK')
except:pass
try:os.mkdir('/sdcard/Alif/CP')
except:pass
try:os.mkdir('/sdcard/Alif/2F')
except:pass


###-----------------------[TERMUX DISPLAY NME ON THE SESSION SITE]-----------------------###
sys.stdout.write('\x1b[1;35m\x1b]2; ALIF-NRD 🙂💗 \x07')
...
def My_Agents():
    try:
        ua=open('nrdagents.txt','r').read().splitlines()
        for ub in ua:
            ugen.append(ub)
    except:
        a=requests.get('https://github.com/Alif-NRD/NRDServer/blob/main/Nrdagents.txt').text
        ua=open('.nrdagents.txt','w')
